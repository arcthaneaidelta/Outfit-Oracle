...
export default function VirtualTryOn({ wardrobe, saveOutfit }) {
  ...
  // selectedItems stores the original item object
  ...
  // processedImages stores the transparent URL generated by the AI
  ...
  const handleSelectItem = async (categorySlot, item) => {
    ...
    // Set the original item immediately for UI feedback (checkmarks, etc.)
